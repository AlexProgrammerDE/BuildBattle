...
public class SetupInventory {
  ...
  public SetupInventory(BaseArena arena) {
    ...
    inventory.setItem(
        ClickPosition.SET_ENDING.getPosition(),
        new ItemBuilder(Material.REDSTONE_BLOCK)
            .name(
                ChatColor.GOLD + "► Set" + ChatColor.RED + " ending " + ChatColor.GOLD + "location")
            ...
            .build());
    inventory.setItem(
        ClickPosition.SET_LOBBY.getPosition(),
    ...
    inventory.setItem(
        ClickPosition.SET_MINIMUM_PLAYERS.getPosition(),
    ...
    inventory.setItem(
        ClickPosition.SET_MAXIMUM_PLAYERS.getPosition(),
    ...
    if (!plugin.getConfigPreferences().getOption(ConfigPreferences.Option.BUNGEE_ENABLED)) {
      inventory.setItem(
          ClickPosition.ADD_SIGN.getPosition(),
    ...
    inventory.setItem(
        ClickPosition.SET_GAME_TYPE.getPosition(),
        new ItemBuilder(XMaterial.CLOCK.parseItem())
            ...
            .build());
    inventory.setItem(
        ClickPosition.SET_MAP_NAME.getPosition(),
        new ItemBuilder(Material.NAME_TAG)
            ...
            .build());
    inventory.setItem(
        ClickPosition.ADD_GAME_PLOT.getPosition(),
        new ItemBuilder(Material.BARRIER)
            ...
            .build());
    inventory.setItem(
        ClickPosition.ADD_FLOOR_CHANGER_NPC.getPosition(),
        new ItemBuilder(Material.GRASS)
            ...
            .build());
    inventory.setItem(
        ClickPosition.REGISTER_ARENA.getPosition(),
        new ItemBuilder(XMaterial.FIREWORK_ROCKET.parseItem())
    ...
    inventory.setItem(
        16,
        new ItemBuilder(XMaterial.GOLD_INGOT.parseItem())
    ...
    inventory.setItem(
        17,
        new ItemBuilder(XMaterial.FILLED_MAP.parseItem())
      ...
      case 0:
        p.sendMessage(
            plugin
                .getChatManager()
                .colorRawMessage(
                    "&e&lTIP: &7We are open source! You can always help us by contributing! Check https://github.com/Plugily-Projects/BuildBattle"));
        break;
      case 1:
        p.sendMessage(
            plugin
                .getChatManager()
                .colorRawMessage(
                    "&e&lTIP: &7Help us translating plugin to your language here: https://translate.plugily.xyz"));
        break;
      case 2:
        p.sendMessage(
            plugin
                .getChatManager()
                .colorRawMessage(
                    "&e&lTIP: &7Download some free maps! Get them here: https://wiki.plugily.xyz/minecraft/buildbattle/free_maps.php"));
        break;
      case 3:
        p.sendMessage(
            plugin
                .getChatManager()
                .colorRawMessage(
                    "&e&lTIP: &7You can use PlaceholderAPI placeholders from our plugin! Check: https://wiki.plugily.xyz/minecraft/buildbattle/papi_placeholders.php"));
        break;
      case 4:
        p.sendMessage(
            plugin
                .getChatManager()
                .colorRawMessage(
                    "&e&lTIP: &7Suggest new ideas for the plugin or vote on current ones! https://app.feedbacky.net/b/BuildBattle"));
        break;
      case 5:
        p.sendMessage(
            plugin
                .getChatManager()
                .colorRawMessage(
                    "&e&lTIP: &7Console can execute /bba votes <add/set> [amount] (player) command! Add super votes via console!"));
        break;
      default:
        break;
    }
  ...
  private String isOptionDoneBool(String path) {
    ...
    if (Bukkit.getServer()
        ...
        .get(0)
        .getSpawnLocation()
        .equals(LocationSerializer.getLocation(config.getString(path)))) {
      return ChatColor.GOLD + "" + ChatColor.BOLD + "Done: " + ChatColor.RED + "No";
    }
