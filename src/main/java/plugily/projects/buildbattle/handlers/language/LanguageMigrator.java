...
public class LanguageMigrator {
  ...
  public LanguageMigrator(Main plugin) {
    ...
    if (config.isSet("Build-Time")) {
      ...
      if (file.exists()
          && file.renameTo(
              new File(plugin.getDataFolder() + File.separator + "oldbb_config.yml"))) {
  ...
  private void configUpdate() {
    ...
    Debugger.sendConsoleMsg(
        "&e[BuildBattle] System notify >> Your config file is outdated! Updating...");
    ...
    Debugger.sendConsoleMsg(
        "&a[BuildBattle] [System notify] Config updated, no comments were removed :)");
    Debugger.sendConsoleMsg(
        "&a[BuildBattle] [System notify] You're using latest config file version! Nice!");
  }

  private void languageFileUpdate() {
    FileConfiguration config = ConfigUtils.getConfig(plugin, "language");
    if (config
        .getString("File-Version-Do-Not-Edit", "")
        .equals(String.valueOf(LANGUAGE_FILE_VERSION))) {
      return;
    }
    Debugger.sendConsoleMsg(
        "&e[BuildBattle] [System notify] Your language file is outdated! Updating...");
    ...
    for (int i = version; i < LANGUAGE_FILE_VERSION; i++) {
      switch (version) {
        case 0:
          MigratorUtils.insertAfterLine(
              file, "Arena-Started", "  Wait-For-Start: \"&cYou must wait for arena start!\"");
          MigratorUtils.insertAfterLine(
              file, "No-Arena-Like-That", "  No-Playing: \"&cYou're not playing!\"");
          MigratorUtils.insertAfterLine(
              file,
              "Admin-Messages:",
        ...
        case 3:
          ...
          MigratorUtils.insertAfterLine(
              file,
              "Join-Cancelled-Via-API:",
              "  Nobody: \"&eNobody\"\r\n  No-Theme-Yet: \"&cVoting\"");
          MigratorUtils.insertAfterLine(
              file, "Commands:", "  No-Free-Arenas: \"&cThere are no free arenas!\"");
          break;
        case 4:
          MigratorUtils.insertAfterLine(
              file,
        ...
        case 5:
          MigratorUtils.insertAfterLine(
              file,
              "Theme-Voting:",
              "    Super-Vote-Item-Name: \"&bSuper vote\"\r\n"
          ...
          MigratorUtils.insertAfterLine(
              file, "Stats-Command:", "    Super-Votes: \"&aSuper votes: &e\"");
          MigratorUtils.insertAfterLine(
              file,
              "No-Free-Arenas:",
              "  Statistics:\r\n"
        ...
        case 6:
          MigratorUtils.insertAfterLine(
              file,
              "Admin-Commands:",
              "    Theme-Blacklisted: \"&cThis theme cannot be used in game!\"");
          break;
        case 7:
          MigratorUtils.insertAfterLine(
              file,
        ...
        case 8:
          ...
          MigratorUtils.insertAfterLine(
              file,
              "Theme-Is-Name:",
              "    Theme-Was-Name: \"&eThe theme was: &a%THEME%&e!\"\r\n"
        ...
        case 9:
          MigratorUtils.insertAfterLine(
              file, "Commands:", "  No-Playing: \"&cYou're not playing!\"");
          break;
        case 10:
          MigratorUtils.insertAfterLine(
              file,
        ...
        case 11:
          MigratorUtils.insertAfterLine(
              file,
              "In-Game:",
              "  No-Permission-For-Biome: \"&cYou don't have permission for this biome!\"");
          MigratorUtils.insertAfterLine(
              file,
              "Option-Menu:",
              "    Go-Back-Button:\r\n"
        ...
        case 13:
          MigratorUtils.insertAfterLine(
              file, "Commands:", "  Type-Arena-Name: \"&cPlease type arena ID!\"");
          break;
        case 14:
          MigratorUtils.insertAfterLine(
              file,
              "Theme-Was-Subtitle:",
              "    Theme-Guessed: \"&eAll players guessed the theme!\"");
          break;
        case 15:
          MigratorUtils.insertAfterLine(
              file,
              "Voting-Messages:",
              "      Voted-For-Player-Plot: \"&7The plot owner was &e&l%PLAYER%&7!\"");
          MigratorUtils.insertAfterLine(
              file,
              "Voting-Messages:",
              "      Vote-For-Next-Plot: \"&7You can now vote for this plot!\"");
          break;
        case 16:
          ...
          MigratorUtils.insertAfterLine(
              file,
              "Spectator:",
              "    You-Are-Spectator: \"&eYou're now a spectator! You can fly now!\"");
          MigratorUtils.insertAfterLine(
              file, "Spectator:", "    Spectator-Item-Name: \"&7Players list\"");
          MigratorUtils.insertAfterLine(
              file, "Spectator:", "    Spectator-Menu-Name: \"Players list\"");
          MigratorUtils.insertAfterLine(file, "Spectator:", "    Settings-Menu:");
          MigratorUtils.insertAfterLine(
              file, "Settings-Menu:", "      Item-Name: \"&7Spectator settings\"");
          MigratorUtils.insertAfterLine(
              file, "Settings-Menu:", "      Inventory-Name: \"&7Spectator settings\"");
          MigratorUtils.insertAfterLine(file, "Settings-Menu:", "      Speed-Name: \"&aSpeed\"");
          MigratorUtils.insertAfterLine(
              file, "Commands:", "  Arena-Restarting: \"&cThis arena is currently restarting!\"");
          break;
        case 17:
          MigratorUtils.addNewLines(
              file,
    ...
    Debugger.sendConsoleMsg(
        "&a[BuildBattle] [System notify] You're using latest language file version! Nice!");
  }
  ...
  private void updateConfigVersionControl(int oldVersion) {
    ...
    MigratorUtils.removeLineFromFile(
        file, "# No way! You've reached the end! But... where's the dragon!?");
