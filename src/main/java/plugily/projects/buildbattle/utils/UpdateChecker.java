 ...
 * href="https://spigotmc.org/resources/">SpigotMC</a>. Before any members of this class are
 * accessed, {@link #init(JavaPlugin, int)} must be invoked by the plugin, preferrably in its {@link
 * JavaPlugin#onEnable()} method, though that is not a requirement.
 *
 * <p>This class performs asynchronous queries to <a href="https://spiget.org">SpiGet</a>, an REST
...
public final class UpdateChecker {
  ...
  private static final String UPDATE_URL =
      "https://api.spiget.org/v2/resources/%d/versions?size=1&sort=-releaseDate";
  ...
  /**
   * Represents a result for an update query performed by {@link
