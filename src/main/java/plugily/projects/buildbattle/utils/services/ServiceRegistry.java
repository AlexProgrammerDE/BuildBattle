...
public class ServiceRegistry {
  ...
  public static boolean registerService(JavaPlugin plugin) {
    ...
    plugin
        .getLogger()
        .log(Level.INFO, "Connecting to services, please wait! Server may freeze a bit!");
    try {
      HttpsURLConnection connection =
          (HttpsURLConnection) new URL("https://api.plugily.xyz/ping.php").openConnection();
      ...
      if (responseCode != 200) {
        plugin
            ...
            .log(
                Level.WARNING,
                "Plugily Projects services aren't online or inaccessible from your location! Response: "
                    + responseCode
                    + ". Do you think it's site problem? Contact developer! Make sure Cloudflare isn't blocked in your area!");
      ...
      plugin
          ...
          .log(
              Level.WARNING,
              "Plugily Projects services aren't online or inaccessible from your location!");
      serviceEnabled = false;
      return false;
    }
    ...
    plugin
        .getLogger()
        .log(Level.INFO, "Hooked with ServiceRegistry! Initialized services properly!");
  ...
  public static LocaleService getLocaleService(JavaPlugin plugin) {
    return (!serviceEnabled || registeredService == null || !registeredService.equals(plugin))
        ? null
        : localeService;
  }
