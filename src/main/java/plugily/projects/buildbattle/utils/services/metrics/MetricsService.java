  ...
  public MetricsService(JavaPlugin plugin) {
    if (ServiceRegistry.getRegisteredService() == null
      ...
      throw new IllegalArgumentException(
          "MetricsService cannot be used without registering service via ServiceRegistry first!");
    }
                        ...
                        new Thread(
                                () -> {
                                  try {
                                    ...
                                    URL url =
                                        new URL("https://api.plugily.xyz/metrics/receiver.php");
                                    ...
                                    plugin
                                        .getLogger()
                                        .log(Level.FINE, "Metrics response: " + content.toString());
